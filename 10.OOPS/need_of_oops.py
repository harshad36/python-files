...
=======================
int,float and string these are built in datatypes.If there is need to create user defined datatype, then it can be achived
with the help of OOPS.
In order to remove disadvantage of Security in procedural programming system and to create user defined datatype,
mapping real world entity digitially,there is need of OOPS.
